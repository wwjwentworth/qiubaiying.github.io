...
**执行一下修改文件的命令**
![Alt text](https://image.ibb.co/kTgosp/2.png)
...
**（1）是否是绝对路径/相对路径**
![Alt text](https://image.ibb.co/kTgosp/3.png)
...
如何将命令添加到环境变量里面呢？
**建立软链接**
![Alt text](https://image.ibb.co/kTgosp/4.png)

建立软链接之后，再输入`lingwu`就不会报错了
![Alt text](https://image.ibb.co/kTgosp/5.png)
