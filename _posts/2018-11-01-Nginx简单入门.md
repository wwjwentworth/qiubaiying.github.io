...
# http指令
# Web 服务器一个重要的功能是服务静态文件（图像或静态HTML页面）。例如，Nginx 可以很方便的让服务器从本读/Users/wuwenjie2001/Documents/personalPro/nginx-study/src/app 获取 html 文件，这只需要在http块指令中的server块指令中设置location块指令。
