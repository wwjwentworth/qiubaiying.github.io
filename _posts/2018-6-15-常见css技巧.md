...
### 样式重置
```css
html,body,div,h1,h2,h3,h4,h5,h5,ul,ol,li,p,span,strong,em,i,img,dl,dt,dd,table,tr,th,td,address,abbr,circle,cite,code,embed,iframe,input,image,label,menu,nav,object,pre,select,tbody,textarea,tfoot,thead,title,video{
    padding: 0;
    margin: 0;
    border: 0;
    font: inherit;
